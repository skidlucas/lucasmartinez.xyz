...
export const translations = {
  en: {
    ...
    'now.learning.content': 'jj',
    'now.stack.title': 'stack',
    'now.stack.content': 'typescript, react, nestjs, postgresql',
    'now.reading.title': 'reading',
    'now.reading.content': 'currently reading "the software engineer\'s guidebook" by gergely orosz, "the man who spoke skanish" by andrus kivirähk',
    'now.projects.title': 'side projects',
    'now.projects.content': 'nothing much except working on this site',
